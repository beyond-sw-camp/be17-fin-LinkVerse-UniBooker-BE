package org.example.apiapp.domain.company.model.dto;
...
public class CompanyDto {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(description = "연도별 플랫폼 사용자 통계 응답 DTO")
    public static class StatisticsResponse {

        @Schema(description = "조회 연도", example = "2025")
        private int year;

        @Schema(description = "해당 연도 신규 가입 기업 수", example = "12")
        private long registeredCompanies;

        @Schema(description = "해당 연도 신규 가입 고객 수", example = "845")
        private long registeredCustomers;

        @Schema(description = "현재 활성 상태인 기업 수", example = "128")
