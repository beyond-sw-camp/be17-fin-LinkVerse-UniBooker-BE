...
import com.unibooker.main.domain.user.model.dto.AdminDto;
...
import com.unibooker.main.domain.user.service.AdminService;
import com.unibooker.main.domain.user.service.AuthService;
import com.unibooker.main.domain.user.service.SuperService;
...
public class SuperController {
    ...
    public BaseResponse<CompanyDto.CompanyListResponse> getAllCompanies(
        ...
        com.unibooker.common.enums.CompanyStatus companyStatus = null;
        if (statusFilter != null && !statusFilter.isBlank()) {
            try {
                companyStatus = com.unibooker.common.enums.CompanyStatus.valueOf(statusFilter.toUpperCase());
