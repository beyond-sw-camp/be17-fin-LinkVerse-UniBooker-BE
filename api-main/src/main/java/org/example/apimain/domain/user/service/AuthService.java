...
public class AuthService {
     ...
     */
    public org.example.apimain.domain.user.model.dto.UserDto.LoginResponseWithToken refreshTokenWithRole(String refreshToken) {
        ...
        return org.example.apimain.domain.user.model.dto.UserDto.LoginResponseWithToken.builder()
                .accessToken(newAccessToken)
                .refreshToken(newRefreshToken)
                .userId(user.getId())
                .email(user.getEmail())
    ...
    public org.example.apimain.domain.user.model.dto.UserDto.LoginResponseWithToken loginWithRoles(  // ✅ Main-Service
                                                                                                    String email,
                                                                                                    String password,
     ...
     */
    @Transactional
    public org.example.apimain.domain.user.model.dto.AuthDto.LogoutResponse logout(Long userId) {
        log.info("로그아웃 - userId: {}", userId);

        // TODO: Redis 기반 Refresh Token 삭제
        // tokenStorageService.deleteRefreshToken(userId);

        return org.example.apimain.domain.user.model.dto.AuthDto.LogoutResponse.builder()
                .message("로그아웃되었습니다.")
                .build();
    }
     ...
     * - USER 역할만 허용
     */
    public org.example.apimain.domain.user.model.dto.UserDto.LoginResponseWithToken loginWithCompany(
            String email,
            String password,
            Long companyId) {
